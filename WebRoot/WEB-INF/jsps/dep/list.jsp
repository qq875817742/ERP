...
<script type="text/javascript">
	...
	function showMsg(msg,uuid,pageNum){
		...
		top.$('hid-action').value="${pageContext.request.contextPath }/dep_delete.action?dm.id="+uuid+"&pageNum="+pageNum;
		top.lock.show();
	}
</script>
<div class="content-right">
	...
	<div class="content-text">
		<form action="dep_list.action" method="post">
			<div class="square-o-top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td width="123">&nbsp;</td>
						<td width="62">部门名称:</td>
						<td width="142"><s:textfield name="dqm.name" size="18"></s:textfield></td>
						<td width="60">电话:</td>
						<td width="149"><s:textfield name="dqm.tele" size="18"></s:textfield></td>
						<td width="70"><a id="query"> <img
								src="${pageContext.request.contextPath }/images/can_b_01.gif" border="0" /> </a></td>
						<td width="70">
						<a href="${pageContext.request.contextPath }/dep_input"><img
			   ...
			   <s:else>
				<table width="100%" border="1" cellpadding="0" cellspacing="0">
					...
					<tr align="center" bgcolor="#FFFFFF">
						<td width="13%" height="30">${dep.id}</td>
						<td>${dep.name}</td>
						<td>${dep.tele}</td>
						<td>
							<img src="${pageContext.request.contextPath }/images/icon_3.gif" /> 
							<span style="line-height:12px; text-align:center;"> 
								<s:a action="dep_input.action" cssClass="xiu">修改
								<s:param name="dm.id" value="#dep.id"></s:param>
								<s:param name="pageNum" value="pageNum"></s:param>								
								</s:a>
							</span> 
							<img src="${pageContext.request.contextPath }/images/icon_04.gif" /> 
							<span style="line-height:12px; text-align:center;"> 
								<a href="javascript:void(0)" class="xiu" onclick="showMsg('是否删除该项数据？当前部门删除后，所有部门内的员工将被删除，同时相关数据也将删除！',${dep.id},${pageNum })">删除</a>
							</span>
						</td>
					</tr>
					</s:iterator>
