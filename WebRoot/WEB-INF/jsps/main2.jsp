			...
			<div class="left">
				...
				<div class="left-bottom">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							...
							<tr>
								<td><a class="hei" target="main" href="${pageContext.request.contextPath }/dep_list.action?pageNum=1">&nbsp;&nbsp;&nbsp;&nbsp;部门维护</a></td>
							</tr>
							<tr>
								<td><a class="hei" target="main" href="${pageContext.request.contextPath }/emp_list">&nbsp;&nbsp;&nbsp;&nbsp;员工维护</a></td>
							</tr>
							<tr>
								<td><a class="hei" target="main" href="${pageContext.request.contextPath }/role_list">&nbsp;&nbsp;&nbsp;&nbsp;角色维护</a></td>
							</tr>
							<tr>
								<td><a class="hei" target="main" href="${pageContext.request.contextPath }/res_list">&nbsp;&nbsp;&nbsp;&nbsp;资源维护</a></td>
							</tr>
							<tr>
								<td><a class="hei" target="main" href="${pageContext.request.contextPath }/menu_list"">&nbsp;&nbsp;&nbsp;&nbsp;菜单维护</a></td>
							</tr>
							<tr>
				...
				<table width="98%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						<td width="82%"><img src="${pageContext.request.contextPath }/images/icon_1.gif" />&nbsp; <a
							class="lanyo" href="www.xinboedu.com">新博教育 2017</a></td>
