...
<div class="content-right">
	...
	<div class="content-text">
			...
			<div class="square-order">
				...
				<br/>
				<s:form action="transport_assignSave.action" method="post">
				<s:hidden name="om.id"></s:hidden>
				<table width="100%">
					<tr>
						<td width="50%" align="right">
							<s:select name="om.completer.id" list="empList" listKey="id" listValue="name" cssStyle="width:100px;font-size:20px"></s:select>
						</td>
