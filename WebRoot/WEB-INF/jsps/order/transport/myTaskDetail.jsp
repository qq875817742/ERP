				...
				<table width="100%">
					<tr>
						<td width="50%" align="center">
							<a href="tasks.jsp" style="color:#0f0;font-size:20px;padding-top:2px;font-weight:bold;text-decoration:none;width:82px;height:28px;display:block;background:url(${pageContext.request.contextPath }/images/btn_bg.jpg)">
								结&nbsp;&nbsp;单
							</a>
							<a href="tasks.jsp" style="color:#f00;font-size:20px;padding-top:2px;font-weight:bold;text-decoration:none;width:82px;height:28px;display:block;background:url(${pageContext.request.contextPath }/images/btn_bg.jpg)">
								已结单
							</a>
						</td>
					</tr>
