				...
				<table width="100%">
					<tr>
						<td width="50%" align="center">
							<s:if test="om.status==@com.xinboiedu.erp.invoice.order.vo.OrderModel@ORDER_STATUS_OF_BUY_BUYING">
								<s:a action="transport_taskCompleted" cssStyle="color:#0f0;font-size:20px;padding-top:2px;font-weight:bold;text-decoration:none;width:120px;height:28px;display:block;background:url(images/btn_bg.jpg)">
								任务完成
								<s:param name="om.id" value="om.id"></s:param>
								</s:a>
								
							</s:if>
							<s:else>
								<a href="javascript:history.back()" style="color:#f00;font-size:20px;padding-top:2px;font-weight:bold;text-decoration:none;width:120px;height:28px;display:block;background:url(${pageContext.request.contextPath }/images/btn_bg.jpg)">
								任务已完成
								</a>
							</s:else>
						</td>
