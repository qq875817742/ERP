			...
			<div class="square-order">
				...
				<table width="100%">
					<tr align="center">
						...
						<td width="50%">
							<s:a action="order_buyCheckNoPass" cssStyle="color:#0f0;font-size:20px;padding-top:2px;font-weight:bold;text-decoration:none;width:82px;height:28px;display:block;background:url(images/btn_bg.jpg)">
							驳&nbsp;&nbsp;回
							<s:param name="om.id" value="om.id"></s:param>
							</s:a>
						</td>
