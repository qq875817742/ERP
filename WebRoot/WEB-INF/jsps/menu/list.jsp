...
<script type="text/javascript">
	...
	function showMsg(msg,uuid,pageNum){
		...
		top.$('hid-action').value="${pageContext.request.contextPath }/menu_delete.action?mm.id="+uuid+"&pageNum="+pageNum;
		top.lock.show();
	}
</script>
			...
			<div class="square-o-top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td width="60">所属菜单</td>
						<td width="149">		
							<s:select name="mqm.parent.id" cssClass="kuan" list="queryMenuList" listKey="id" listValue="name" headerKey="-1" headerValue="--请选择--"></s:select>						
						
						</td>
						<td width="70"><a id="query"> <img src="${pageContext.request.contextPath }/images/can_b_01.gif" border="0" /> </a></td>
						<td width="70"><a href="${pageContext.request.contextPath }/menu_input.action"><img src="${pageContext.request.contextPath }/images/can_b_02.gif" border="0" /></a></td>
					</tr>
				</table>
			</div>
			<!--"square-o-top"end-->
					...
					<tr align="center" bgcolor="#FFFFFF">
						...
						<td>
							...
							<span style="line-height:12px; text-align:center;"> 
								<s:a action="menu_input.action" cssClass="xiu">修改
								<s:param name="mm.id" value="id"></s:param>
