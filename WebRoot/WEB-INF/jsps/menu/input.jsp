  			...
  			<div style="border:1px solid #cecece;">
				...
				<table width="100%"  border="0" cellpadding="0" cellspacing="0">
				    <tr  bgcolor="#FFFFFF">
				      ...
				      <td width="32%">
						<s:textfield name="mm.name"></s:textfield>
				      </td>
				      <td width="18%" align="center">所属父菜单</td>
				      <s:if test="mm.id!=null&&mm.parent.id==1">
				       <td width="32%">
				      	<s:textfield value="%{mm.parent.name}" readonly="true"></s:textfield>
				      	<s:hidden name="mm.parent.id"></s:hidden>
				      	 </td>
				      </s:if>
				      <s:else>
				      <td width="32%">			      	
				      	<s:select name="mm.parent.id" list="menuList" listKey="id" listValue="name" cssStyle="width:190px"></s:select>
				      </td>
				      </s:else>
				    ...
				    <tr  bgcolor="#FFFFFF">
				      ...
				      <td width="82%" colspan="3">
				      	<s:textfield name="mm.url"></s:textfield>
				      </td>
				    </tr>
				    <tr  bgcolor="#FFFFFF">
				      <td colspan="4">&nbsp;</td>
