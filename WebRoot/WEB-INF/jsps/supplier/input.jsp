				...
				<table width="100%"  border="0" cellpadding="0" cellspacing="0">
				    <tr  bgcolor="#FFFFFF">
				      ...
				      <td width="82%" colspan="3">
				      	<s:textfield name="sm.name"></s:textfield>
				      </td>
				    </tr>
				    <tr  bgcolor="#FFFFFF">
				      <td colspan="4">&nbsp;</td>
				    ...
				    <tr  bgcolor="#FFFFFF">
				      ...
				      <td width="82%" colspan="3">
				      	<s:textfield name="sm.address" ></s:textfield>
				      </td>
				    </tr>
				    <tr  bgcolor="#FFFFFF">
				      <td colspan="4">&nbsp;</td>
				    ...
				    <tr  bgcolor="#FFFFFF">
				      ...
				      <td width="32%">
				      	<s:textfield name="sm.contact"></s:textfield>
				      </td>
				      <td width="18%" align="center">电话</td>
				      <td width="32%">
				      	<s:textfield name="sm.tele" ></s:textfield>
				      </td>
				    </tr>
				    <tr  bgcolor="#FFFFFF">
				      <td colspan="4">&nbsp;</td>
				    ...
				    <tr  bgcolor="#FFFFFF">
				      ...
				      <td width="32%">      		
						<s:select name="sm.needs" list="@com.xinboiedu.erp.invoice.supplier.vo.SupplierModel@NEEDS_MAP"></s:select>
				      </td>
